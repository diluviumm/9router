...
Guía detallada de instalación de MeAI con consejos de solución de problemas.
...
Instala MeAI globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `meai`
- ✅ Auto-actualizaciones con `npm update -g meai`
...
3. Se crea el directorio de datos en `~/.meai`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/meai'
```
...
**Problema:** MeAI usa demasiada RAM
...
```bash
docker pull meai/meai:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v meai-data:/root/.meai \
  --name meai \
  meai/meai:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con meai
```
