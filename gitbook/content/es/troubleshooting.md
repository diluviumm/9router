...
Problemas comunes y soluciones al usar MeAI.
...
1. **Refresh automático (por defecto):**
   MeAI refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si MeAI está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep meai
