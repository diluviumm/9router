...
Integra MeAI con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de MeAI desde el [dashboard](https://9router.com/dashboard)
- MeAI ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de MeAI
...
```json
{
  "models": [
    ...
    {
      "title": "MeAI - Claude Sonnet (Balanced)",
      "provider": "openai",
...
3. Elige tu modelo preferido de MeAI
...
- Verifica que MeAI esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de MeAI
...
- Verifica la latencia de red hacia MeAI
