...
MeAI es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

MeAI proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a MeAI usando estas configuraciones:

**MeAI local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de MeAI (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a MeAI
```bash
# Verifica si MeAI está corriendo
...
**Solución:**
- Verifica que MeAI esté corriendo
...
- Verifica la conexión de red a MeAI
