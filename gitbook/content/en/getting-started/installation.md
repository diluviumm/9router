...
Detailed installation guide for MeAI with troubleshooting tips.
...
Install MeAI globally to use from anywhere:
...
- ✅ Simple command: `meai`
- ✅ Auto-updates with `npm update -g meai`
...
3. Data directory created at `~/.meai`
