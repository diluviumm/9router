...
Run MeAI on your local machine for development and personal use.

---

## 📦 Installation

Install MeAI globally via npm:
...
Start MeAI with a single command:
...
Press `Ctrl+C` in the terminal where MeAI is running.

```bash
# In the terminal running meai
^C  # Press Ctrl+C
```
