...
MeAI is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

MeAI provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to MeAI using these settings:

**Local MeAI:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any MeAI model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to MeAI
```bash
...
- Check network connection to MeAI
