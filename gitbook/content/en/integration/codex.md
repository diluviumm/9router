...
Integrate MeAI with OpenAI Codex CLI to route your OpenAI API requests through MeAI's intelligent routing system.
...
MeAI provides the following Codex models:
...
1. Verify your API key is correct in MeAI dashboard
...
1. Verify the model name matches your MeAI configuration
2. Check that the OpenAI provider connection is active in MeAI dashboard
...
Make sure you have configured your API key in the MeAI cloud dashboard.
