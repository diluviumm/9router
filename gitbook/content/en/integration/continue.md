...
Integrate MeAI with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- MeAI API key from [dashboard](https://9router.com/dashboard)
- MeAI running (local or cloud)
...
### 2. Add MeAI Model Configuration
...
3. Choose your preferred MeAI model
