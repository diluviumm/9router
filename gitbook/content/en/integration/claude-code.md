...
Integrate MeAI with Claude Code CLI to route your Anthropic API requests through MeAI's intelligent routing system.
...
Claude Code supports the following model aliases that map to MeAI models:
