...
Chạy MeAI trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt MeAI toàn cục qua npm:
...
Khởi động MeAI với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy MeAI.
