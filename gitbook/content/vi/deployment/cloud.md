...
Triển khai MeAI trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.meai` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/meai`:
...
# If NOT using reverse proxy, allow MeAI ports
