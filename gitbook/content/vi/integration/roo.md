...
Tích hợp MeAI với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
### Connection Failed
- Xác minh MeAI đang chạy: `curl http://localhost:20128/health`
