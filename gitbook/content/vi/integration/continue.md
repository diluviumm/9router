...
Tích hợp MeAI với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- MeAI API key từ [dashboard](https://9router.com/dashboard)
- MeAI đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra MeAI đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến MeAI
