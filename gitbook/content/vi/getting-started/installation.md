...
Hướng dẫn cài đặt chi tiết cho MeAI với mẹo troubleshooting.
...
Cài MeAI toàn cục để dùng ở bất kỳ đâu:
...
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `meai`
- ✅ Auto-update với `npm update -g meai`
...
3. Data directory được tạo tại `~/.meai`
...
**Vấn đề:** MeAI dùng quá nhiều RAM
