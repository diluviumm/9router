...
const APP_NAME = "meai";
const APP_LABEL = "com.meai.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when meai is currently
 ...
 * SIGTERM to the running process. When the running meai cli.js was itself
...
<dict>
    ...
    <string>/tmp/meai.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/meai.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `meai.cmd` lookup that depended on the npm prefix path.
