/**
 * `meai xai video` — generate a Grok Imagine video through the local
 * meai gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: meai xai video --prompt "..." [options]

Generate a Grok Imagine video via your local meai gateway
...
Options:
  ...
  --api-key <key>         meai API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-meai-connection-id"] || null;
