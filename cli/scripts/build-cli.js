...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/meai/server.js.
...
function buildCliPackage() {
  console.log("📦 Building MeAI CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.meai/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.meai/runtime)");
  }
  console.log("");
