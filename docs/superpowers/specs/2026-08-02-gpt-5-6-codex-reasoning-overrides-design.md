...
The same matrix applies to meai's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside meai;
  meai only forwards the catalog-advertised reasoning override.
