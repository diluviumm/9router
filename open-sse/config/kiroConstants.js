 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what meai needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a meai
 ...
 * The suffix is a meai request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a meai synthetic agentic variant.
...
/**
 * Detect whether a model id is a meai synthetic thinking variant
...
/**
 * Resolve a meai model id to the real upstream Kiro model id, plus flags
