 ...
 * API. They are meai fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic meai variant set for a single upstream Kiro model.
 *
 ...
 * into meai variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
