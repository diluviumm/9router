...
const endpoints = createStore({
  storageKey: "meai.cliToolEndpointPresets",
  changeEvent: "meai:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "meai.cliToolApiKeyPresets",
  changeEvent: "meai:api-key-presets-changed",
  itemField: "key",
});
